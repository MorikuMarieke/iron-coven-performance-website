  ...
  return (
    <div className="arcana-card-body relative flex flex-1 flex-col px-2.5 pb-3 pt-2">
      ...
      <div className="flex items-center justify-center gap-2 py-1.5">
        <span className="text-sm opacity-70" style={{ color: accent.primary }} aria-hidden="true">
          ✦
        </span>
        <h3
          className="font-maguntia text-lg leading-tight md:text-xl"
      ...
      <div className="mt-0.5 flex min-h-0 flex-1 gap-2">
        <div className="flex min-w-0 flex-1 flex-col justify-center gap-0.5">
          <DossierField label="Alignment" value={performer.alignment} color={accent.primary} />
          <DossierField label="Element" value={performer.element} color={accent.primary} />
          <DossierField label="Medium" value={mediumDisplay} color={accent.primary} />
        </div>

        <div
          className="arcana-portrait-frame w-[44%] shrink-0 overflow-hidden rounded-sm"
          style={{ borderColor: accent.border }}
        >
          <ArcanaPortrait src={performer.portraitSrc} name={performer.name} accent={accent.primary} />
        </div>
      </div>
